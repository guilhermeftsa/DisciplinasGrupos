...
public class DisciplinasPage extends br.unifor.teste.disciplinasgrupos.core.BasePage {
...
//	}
	...
	public List<MobileElement> obterDisciplinas(){		
	...
	public boolean existeCampoTurma() {
		return existeElementoPorId("br.unifor.mobile:id/frequenciaTurma");
	}
	...
	public boolean isDisciplinasOrdenadas() {
		...
		//Salva a lista de Disciplinas exibidas formatadas sem o c�digo		
		...
		int resultado = 0;
		//Ordena as disciplinas e confere se est�o mesmo ordenadas alfabeticamente
	...
	public boolean checarBuscaVazia(){
		return existeElementoPorTexto("Não foram encontrados nenhum resultado na busca");
	}
	...
	public boolean existeCampoCodigo() {
		return existeElementoPorId("br.unifor.mobile:id/turmaDisciplina");
	}
